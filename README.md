...
- Make sure `bank-full.csv` is in the same folder or upload it to Colab.

### Dataset
- [Bank Marketing Dataset - UCI ML Repository](https://archive-beta.ics.uci.edu/dataset/222/bank%2Bmarketing?utm_source=chatgpt.com)
